		...
		"telegramGetUpdates",
		{
			...
			execute: async (input) => {
				...
				const result = await telegramApi<Array<{
					...
					channel_post?: { message_id: number; text?: string; caption?: string; date?: number; chat: { id: number; title?: string; type?: string }; document?: unknown; photo?: unknown; video?: unknown };
